...
function test_case()
{
	...
	do
		...
		fio -filename=/dev/$blk -ioengine=sync -direct=1 -iodepth=128 -rw=randwrite -bs=4k -size=1G -numjobs=8 -runtime=10 -group_reporting -name=fio_test
